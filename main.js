...
console.log(chalk.bgWhiteBright.magentaBright.italic.bold("\n\t  Welcome to the Countdown Timer...\t\n"));
async function main() {
...
function startTimer(duration, isSeconds) {
    ...
    let interval = setInterval(async () => {
        ...
        console.log(chalk.magentaBright(`${minutes.toString().padStart(2, "0")} : ${seconds.toString().padStart(2, "0")}`));
    }, 1000);
}
main();
